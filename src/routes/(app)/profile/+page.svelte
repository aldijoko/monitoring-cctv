<script lang="ts">
	...
	let fullName = $state($user?.username ?? '');
			...
			<Card>
				...
				>
					<div class="flex items-center justify-between py-3">
						...
						<dd>
							<span
								class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium {$user
									.is_active
					...
					<div class="flex items-center justify-between py-3">
						...
						<dd class="font-mono text-gray-900">{$user.tenant_id}</dd>
					</div>
					<div class="flex items-center justify-between py-3">
